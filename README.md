<p align="center">
  <img src="./assets/readme/hero.svg" width="100%" alt="ARAMGG 助手：极地大乱斗与斗魂竞技场只读推荐、海克斯 OCR 和游戏内浮窗" />
</p>
...
<p align="center">
  面向 Windows 的英雄联盟极地大乱斗与斗魂竞技场桌面助手：选人阶段给出英雄与席位建议，对局中识别海克斯，并把胜率、出装与技能建议放到游戏旁边；斗魂竞技场还提供棱彩装备和符文/英雄/组合榜单。
</p>
...
斗魂竞技场沿用它已有的本地优先数据、只读 LCU 与增量 OCR 原则，并额外覆盖棱彩装备、符文/英雄/组合榜单和托管装备方案。
...
3. 进入极地大乱斗或斗魂竞技场：选人阶段查看英雄详情与席位建议；进入对局后等待海克斯界面出现。
